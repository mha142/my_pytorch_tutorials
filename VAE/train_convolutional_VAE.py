...
# checkpoint = torch.load("trained_mnist_conv_vae_epoch_0.pth")
...
#for currrent_epoch in range(epoch + 1,NUM_EPOCHS):
for currrent_epoch in range(NUM_EPOCHS):
    ...
    checkpoint(model, optimizer, currrent_epoch, f"trained_mnist_conv_vae_batchsize_{BATCH_SIZE}_lr_{LR_RATE}_epoch_{currrent_epoch+1}.pth")
