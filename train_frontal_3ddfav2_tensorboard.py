...
def train_processed_images_plot_after_every_epoch():
    ...
    for epoch in range(start_epoch, n_epochs+1):  # loop over the dataset multiple times
        ...
        trainingEpoch_loss.append(loss_per_epoch)
        ...
        save_checkpoint(model, optimizer, epoch, f"trained_ffhq_conv_vae_epoch_{epoch+1}.pth")
